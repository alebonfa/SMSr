...
<body>
	...
	echo "<h1>CURSOS</h1>";
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms03.dbf', 0);
	if($tabelaDBF) {
	...
	echo "<h1>POLOS</h1>";
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms02.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	echo "<h1>Turmas</h1>";
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms01.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms05.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms04.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms06.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	echo "<h1>Módulos</h1>";
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms07.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms08.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	echo "<h1Alunos</h1>";
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms10.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
	...
	echo "<h1>Módulos</h1>";
	$tabelaDBF = dbase_open('c:/xampp/htdocs/luanda/contas/smsr/sms09.dbf', 0);
	if($tabelaDBF) {
		$DBF_lenght = dbase_numrecords($tabelaDBF);
		for($i = 1; $i <= $DBF_lenght; $i++) {
